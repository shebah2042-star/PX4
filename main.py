"""
البرنامج الرئيسي لنظام التحكم في الصاروخ
Rocket Control System - Main Program
"""
...
class RocketControlSystem:
    ...
    def __init__(self):
        ...
        self.logger.info("=" * 60)
        self.logger.info("نظام التحكم في الصاروخ - Rocket Control System")
        self.logger.info("=" * 60)
    ...
    def setup_logging(self):
        ...
        logging.basicConfig(
            ...
            handlers=[
                logging.FileHandler(f'logs/rocket_system_{datetime.now().strftime("%Y%m%d_%H%M%S")}.log'),
    ...
    async def handle_ascent(self, attitude: dict, altitude: float, velocity: float):
        ...
        # تطبيق الأوامر
        await self.servo_controller.set_fin_deflections(roll_cmd, pitch_cmd, yaw_cmd)
